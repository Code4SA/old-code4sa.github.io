(function() {
    ...
    */
    ...
    var draw_meeting = function(el) {
        ...
        node.append('span').text(new Date(el[0]['Date']).toDateString());
    ...
    var draw_meetings = function(node, meetings) {
        d3.select('#committee-title').text(meetings[0][0]['Name Committee'])
